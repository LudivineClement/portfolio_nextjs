...
const Contact = () => {
  return (
    <section data-section id='contact' className='pt-24 px-12 -my-24 m-auto max-w-[1250px]'>
      ...
      Harum architecto numquam, placeat ullam in ea qui consequatur, quasi fugiat accusamus ex. Suscipit, maxime at. Fuga saepe omnis minima illum error eius optio. Sed nostrum consectetur molestias dolores inventore.
      Rem minus delectus voluptates quae quos, velit distinctio magnam tempora facilis odit magni sint enim laudantium sit ratione nobis aspernatur saepe quisquam hic aliquam ipsa recusandae accusamus eveniet? Aliquam, esse.
      Ex quasi adipisci voluptate maiores obcaecati repudiandae quas, officiis reiciendis libero commodi quibusdam quaerat aut voluptatibus earum, alias modi quos dolore ad quisquam laboriosam doloremque labore minima harum. Dolor, veritatis.
      Sequi nemo neque sit dolore architecto. Dicta ipsum enim, iure quibusdam qui reiciendis aliquid praesentium omnis consequuntur explicabo. Pariatur aut unde vitae fugiat hic voluptas sunt nobis recusandae labore illum.
