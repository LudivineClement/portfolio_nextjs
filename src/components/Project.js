...
const Project = () => {
  ...
  return (
    <section data-section id="projects" className="px-5 py-14 -my-14 md:px-6 md:py-20 md:-my-20 lg:pt-24 lg:px-12 lg:-my-24 m-auto max-w-[1250px]">
      ...
      <div
        className={`grid md:grid-cols-2 lg:grid-cols-3 gap-x-8 gap-y-10 transition-transform duration-[1200ms] md:duration-[1000ms] will-change-transform ease-in-out ${isModalOpen ? 'translate-x-[-45%]' : 'translate-x-0'}`}
      >
