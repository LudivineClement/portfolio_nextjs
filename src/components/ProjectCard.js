...
const ProjectCard = ({ img, title, github, url, ToggleProjectInfo }) => {
  ...
  return (
    <div className="bg-white group relative overflow-hidden h-[400px] cursor-pointer shadow-sm will-change-transform">
      ...
      />
      <div className='absolute w-full bg-pink-global h-0 z-10  cursor-default -bottom-5 p-4 group-hover:lg:h-[100px] group-hover:lg:opacity-80 group-hover:lg:bottom-0 transition-bottom duration-500 ease-in-out opacity-90'>
