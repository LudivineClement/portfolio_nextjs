...
const SectionCTA = () => {
  return (
    <section className='section_cv text-off-white bg-bg-black bg-center bg-cover bg-fixed bg-gray-global brightness-[1.5] p-20 mt-[120px] mb-5 flex flex-col justify-center items-center gap-6 '>
